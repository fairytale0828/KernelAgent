...
def aggregate_single_compute_graph(
    ...
    flash_attention_fusions = _find_flash_attention_pattern(subgraphs, dataflow_graph)
    ...
    matmul_act_fusions = _find_matmul_activation_pattern(subgraphs, used_indices, dataflow_graph)
